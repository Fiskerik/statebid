...
export default function PrivacyPage() {
  ...
  return <LegalPage eyebrow="Privacy · Draft for legal review" title="Small data footprint. Clear public data." intro="StateBid has no bidder accounts and does not collect a bidder email inside the application. Stripe may collect billing and receipt details within hosted Checkout.">
    ...
    <h2>6. Security and operational data</h2><p>We process short-lived IP and browser signals for rate limits, abuse prevention, Turnstile checks, webhook logs, error monitoring, moderation records, and operator-authentication audit. Public reports can be submitted without an account or email.</p>
